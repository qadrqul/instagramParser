...
class InstagramBot():
    ...
    def get_all_posts_urls(self, userpage):
        ...
        if self.xpath_exists(wrong_userpage):
            ...
            posts_count = browser.find_element(By.XPATH,
                                                   "/html/body/div[2]/div/div/div/div[1]/div/div/div/div[1]/div[1]/div[2]/section/main/div/header/section/ul/li[1]/div/span/span").text

            int_posts_count = int(''.join([n for n in posts_count if n.isdigit()]))
            loops_count = int(int_posts_count / 86)
            print(loops_count)
    ...
    def download_userpage_content(self, userpage):
        ...
        with open(f'{file_name}_set.txt') as file:
            ...
            for post_url in urls_list[0:2500]:
                try:
                    ...
                    video_src = "/html/body/div[2]/div/div/div/div[1]/div/div/div/div[1]/div[1]/div[2]/section/main/div[1]/div[1]/article/div/div[1]/div/div/div/div/div/div/div/video"
...
my_bot.login()
my_bot.download_userpage_content("https://www.instagram.com/userpage/")
